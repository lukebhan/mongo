...
TEST(Uint128, MaxUint) {
    ...
    testValuesEqualUint128(
        "340282366920938463463374607431768211455", 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF);
}
...
TEST(Uint128, OutOfBounds) {
    boost::optional<uint128_t> val =
        UInt128::MakeUint128FromString("340282366920938463463374607431768211456");
...
TEST(Int128, MaxInt) {
    ...
    testValuesEqualInt128(
        "170141183460469231731687303715884105727", 0x7FFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF);
}
...
TEST(Int128, OutOfBounds) {
    boost::optional<int128_t> val =
        Int128::MakeInt128FromString("-170141183460469231731687303715884105728");
    ASSERT_TRUE(val == boost::none);
}
